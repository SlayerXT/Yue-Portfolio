  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-video overflow-hidden">
        ...
        {/* Hover Overlay */}
        <div className="absolute inset-0 bg-osc-green/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-12 h-12 rounded-full bg-osc-green flex items-center justify-center transform scale-0 group-hover:scale-100 transition-transform duration-300">
